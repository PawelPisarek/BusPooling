...
public class TransportOfferRepository extends AbstractRepository implements IRepository<TransportOffer, TransportOfferEntity>, MongoDatastore<TransportOffer, TransportOfferEntity, TransportOffer> {
    ...
    public TransportOfferEntity buildEntity(TransportOffer object) {
        final TransportOfferEntity transportOfferEntity = new TransportOfferEntity(object.getPrice(), object.getTransportName(), object.getSeats(), object.getIsJoined(), object.getDelayedTransportEntity());
    ...
    public TransportOffer buildResponse(TransportOfferEntity entity) {
        return new TransportOffer(entity.getId().toString(), entity.getPrice(), entity.getTransportName(), entity.getSeats(), entity.getIsJoined(), entity.getDelayedTransportEntity());
    }
